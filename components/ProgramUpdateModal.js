...
export default function ProgramUpdateModal({movementId,get,Open,Close}) {
    const url = data.url
    ...
    let reqInstance = axios.create({
      ...
      const updateLogData =() =>{
          reqInstance.put(`${url}update-single-logdata/${movementId}`,
          {
      ...
      buttonStyle={styles.dropdown} />
        ...
        />
            ...
            />
                  ...
                  <Pressable style={styles.Button} onPress={() =>  { Close(false);updateLogData();get()}}>
